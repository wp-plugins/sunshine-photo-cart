	...
	<div id="sunshine-main">
		...
		<div class="sunshine-form" id="sunshine-order">
			...
			<div id="sunshine-order-billing-fields">
				...
				<div class="field field-right"><label><?php _e('State / Province','sunshine'); ?></label> <?php echo $order_data['state']; ?></div>
			...
			<div id="sunshine-order-shipping-fields">
				...
				<div class="field field-right"><label><?php _e('State / Province','sunshine'); ?></label> <?php echo $order_data['shipping_state']; ?></div>
